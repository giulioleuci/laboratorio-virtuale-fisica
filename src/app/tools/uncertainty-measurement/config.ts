...
import { sampleStdDev, weightedMean, stdErrMean } from '@/lib/stats';

export const uncertaintyMeasurementFormula: Formula = {
    id: 'uncertainty-measurement',
    title: 'Misure di incertezze',
    description: "Confronta la deviazione standard, l'errore standard della media e la semidispersione massima come stime dell'incertezza.",
    category: 'Strumenti',
    getInputs: () => [
        {
            id: 'x',
    ...
    calculation: (processedInputs, modes, rawData) => {
        ...
        const standardError = stdErrMean(values);
        ...
        return {
            ...
            "Errore standard della media": { value: standardError, sigma: null, unit: '' },
